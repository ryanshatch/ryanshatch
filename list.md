<br>
<h1 align="center">Organized List of All Repositories</h1>
<!-- *******************************************************************************************************************************************************
...
<p align="center"><br>
  <strong>Top Programs:</strong><br><br>
...
<div align="center">
  ...
  <p>A repository containing bugs and exploits found in the CanvasHairCo system.</p><br>
  ...
  <p>A repository dedicated to baiting scammers.</p><br>

  <h2><a id="ryanshatch-github-io"></a><a href="https://github.com/ryanshatch/ryanshatch.github.io">ryanshatch.github.io</a></h2>
  <p>The GitHub Pages repository for Ryan Hatch's personal website.</p><br>
  ...
  <p>A public template for a self-study plan in web development.</p><br>

  <h2><a id="malware"></a><a href="https://github.com/ryanshatch/Malware">Malware</a></h2>
  <p>An archive of malware files for educational purposes. The author is not responsible for any misuse or abuse of these files.</p><br>

  <h2><a id="streams-of-sorrow"></a><a href="https://github.com/ryanshatch/Streams-of-Sorrow">Streams of Sorrow</a></h2>
  <p>A Python script that displays a poem in English and Turkish about the sorrowful waterwheel, as a tribute to the ongoing conflict between Israel & Palestine.</p><br>
  ...
  <p>A random number guessing game in Python.</p><br>

  <h2><a id="paint-calculator"></a><a href="https://github.com/ryanshatch/Paint-Calculator">Paint Calculator</a></h2>
  <p>A Java program that calculates the amount of paint needed to cover a wall area.</p><br>
  ...
  <p>The Name and Age Calculator is a simple program created to prompt the user for their name and age, and calculates their birth year based on the current year.</p><br>

  <h2><a id="solana-pnl-calculator"></a><a href="https://github.com/ryanshatch/Solana-PNL-Calculator">Solana PNL Calculator</a></h2>
  <p>A program that calculates the profit and loss of a Solana wallet.</p><br>

  <h2><a id="hangman-py"></a><a href="https://github.com/ryanshatch/Hangman.py">Hangman.py</a></h2>
  <p>The classic word-guessing game Hangman implemented in Python.</p><br>

  <h2><a id="logme"></a><a href="https://github.com/ryanshatch/Logme">Logme</a></h2>
  <p>This is a very basic keylogger that helps monitor keystrokes without any additional packages or installations other than Python.</p><br>
